...
import { MagnetSystem } from './components/Magnets.jsx';
import { Rotor } from './components/Rotor.jsx';
import { Circuit } from './components/Circuit.jsx';
import { FieldLines } from './components/FieldLines.jsx';
import { Controls } from './components/Controls.jsx';
import { COLORS } from './constants.js';

const SceneContent = ({ speed, showField }) => {
  return (
    <>
...
export default function App() {
  const [speed, setSpeed] = useState(2); // Default matches HTML value
